...
public class CreateBootcampImageCommand : IRequest<CreatedBootcampImageResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class CreateBootcampImageCommandHandler : IRequestHandler<CreateBootcampImageCommand, CreatedBootcampImageResponse>
    {
        ...
        public CreateBootcampImageCommandHandler(IMapper mapper, IBootcampImageRepository bootcampImageRepository,
        ...
        public async Task<CreatedBootcampImageResponse> Handle(CreateBootcampImageCommand request, CancellationToken cancellationToken)
        {
