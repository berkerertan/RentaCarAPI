...
#pragma warning disable S1854 // Unused assignments should be removed
    private IEnumerable<OperationClaim> getFeatureOperationClaims(int initialId)
    {
        ...
        #region ApplicationInfoes
        featureOperationClaims.AddRange(
            [
                new() { Id = ++lastId, Name = ApplicationInfoesOperationClaims.Admin },
                new() { Id = ++lastId, Name = ApplicationInfoesOperationClaims.Read },
                new() { Id = ++lastId, Name = ApplicationInfoesOperationClaims.Write },
                new() { Id = ++lastId, Name = ApplicationInfoesOperationClaims.Create },
                new() { Id = ++lastId, Name = ApplicationInfoesOperationClaims.Update },
                new() { Id = ++lastId, Name = ApplicationInfoesOperationClaims.Delete },
            ]
        );
        #endregion
